    ...
    sessions: [
      {
        ...
        participants: ['Me', 'Diana', 'Research Agent'],
        artifacts: 4,
        tasks: 2,
        unread: 0,
        messages: [
      ...
      },
      {
        ...
        participants: ['Me', 'Alice', 'Security Agent'],
        artifacts: 2,
        tasks: 3,
        unread: 0,
        messages: [
      ...
      },
      {
        ...
        lastActive: '1h ago',
        status: 'Mapped',
        participants: ['Me', 'Bob', 'Code Agent'],
        artifacts: 6,
        tasks: 2,
        unread: 0,
        messages: [
    ...
    sessions: [
      {
        ...
        lastActive: '32m ago',
        status: 'Negotiating',
        participants: ['Me', 'Calendar Agent', 'Listing Agent'],
        artifacts: 1,
        tasks: 2,
        unread: 0,
        messages: [
      ...
      },
      {
        ...
        status: 'Collecting',
        participants: ['Me', 'My Core Agent', 'Michael'],
        artifacts: 4,
        tasks: 2,
        unread: 0,
        messages: [
    ...
    sessions: [
      {
        ...
        lastActive: '2h ago',
        status: 'Planning',
        participants: ['Me', 'Carol', 'Mercury Planner Agent'],
        artifacts: 7,
        tasks: 4,
        unread: 0,
        messages: [
      ...
      },
      {
        ...
        lastActive: '4h ago',
        status: 'In progress',
        participants: ['Me', 'Code Agent', 'Delta Builder Agent'],
        artifacts: 5,
        tasks: 3,
        unread: 0,
        messages: [
