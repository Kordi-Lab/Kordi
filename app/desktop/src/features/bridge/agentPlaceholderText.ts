/**
 * Shared text helpers for detecting bridge-agent placeholder strings.
 *
 * These were duplicated in `features/bridge/transcript.ts` and
...
/**
 * Returns true if a bridge message body is the synthetic "processing..." /
