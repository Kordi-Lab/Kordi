...
export function useKordiAppModel({
  ...
  const {
    ...
    project: {
      ...
      selectProjectSession, setProjectWorkspaces: projectsUi.setProjectWorkspaces,
    },
    runtime: {
      desktopChatState, desktopCollaborationState, canonicalSessionState,
    ...
    authNavigation: {
      handleSelectAuthChoice, refreshDesktopAuth, refreshDesktopChat,
      handleCreateChatSession, handleRenameDesktopSession,
      setActiveNav,
      setActiveSettingsSectionId: settingsUi.setActiveSettingsSectionId,
      setActiveDetailTab,
      setIsDetailPanelCollapsed,
    ...
    messageRuntime: {
      setDesktopChatState, setDesktopChatError,
      isDesktopChatSending: isDesktopCollaborationSending,
      setIsDesktopChatSending: setIsDesktopCollaborationSending,
      setPendingUserChatMessage, queuedDesktopMessagesBySession,
      setQueuedDesktopMessagesBySession, setDesktopLiveTurnsBySession,
      setCloudCollaborationState,
      sendCloudCollaborationMessage,
      sendCloudGroupControl,
      cancelCloudAgentRequest,
