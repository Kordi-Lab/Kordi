...
export function buildChatsPageProps(args: MainContentShellArgs): ComponentProps<typeof ChatsPage> {
  ...
  return {
    ...
    onEditMessage: args.onEditMessage,
    ...
    activeMessageEdit: args.activeMessageEdit,
    messageEditBusy: args.messageEditBusy,
    messageEditError: args.messageEditError,
    updateMessageEditText: args.updateMessageEditText,
    cancelMessageEdit: args.cancelMessageEdit,
    saveMessageEdit: args.saveMessageEdit,
    },
    runtime: {
