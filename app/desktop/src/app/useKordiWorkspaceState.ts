...
export function useKordiWorkspaceState(foundation: KordiAppFoundation) {
  const {
    ...
    cloud: {
      ...
      cloudUnreadSessionIds,
      cloudPinnedSessionIds,
      cloudMutedSessionIds,
      cloudPinnedGroupSpaceIds,
  ...
  const {
    ...
    onForwardSelectedMessages, activeMessageEdit, messageEditBusy, messageEditError,
  ...
  return {
    conversations: {
      ...
      activeCollaborationConversationHost,
      activeCollaborationAwaitingReply,
      pinnedSessionIds: cloudPinnedSessionIds,
      mutedSessionIds: cloudMutedSessionIds,
      unreadSessionIds: cloudUnreadSessionIds,
      pinnedGroupSpaceIds: cloudPinnedGroupSpaceIds,
    },
    directory: {
      displayedContacts,
      addableContacts,
