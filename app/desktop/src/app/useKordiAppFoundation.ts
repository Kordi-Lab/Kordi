...
export function useKordiAppFoundation({
  ...
  const {
    ...
    setCloudMessageReaction, recordCloudSessionFork, updateCloudSessionPin, prepareCloudSessionPin,
  ...
  return {
    ...
    cloud: {
      ...
      sendCloudGroupControl, setCloudMessageReaction, recordCloudSessionFork, updateCloudSessionPin, prepareCloudSessionPin,
