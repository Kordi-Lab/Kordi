...
export function useKordiShellArgs(args: AssembleKordiShellSlotsArgs): KordiShellArgs {
  return useMemo(() => ({
    sidebar: {
      ...
      handleInstallDesktopUpdate: args.handleInstallDesktopUpdate,
      handleRestartDesktopUpdate: args.handleRestartDesktopUpdate,
      handleCancelDesktopUpdateRestart: args.handleCancelDesktopUpdateRestart,
    ...
    mainContent: {
      ...
      handleSetBridgeHostPrivacyPolicy: args.handleSetBridgeHostPrivacyPolicy,
      handleSetBridgeAgentReachabilityPolicy: args.handleSetBridgeAgentReachabilityPolicy,
      handleApproveBridgeContactRequest: args.handleApproveBridgeContactRequest,
      handleRejectBridgeContactRequest: args.handleRejectBridgeContactRequest,
