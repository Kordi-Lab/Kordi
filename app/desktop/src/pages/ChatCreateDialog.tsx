  ...
  return (
    <>
      ...
      <div
        ...
        className="app-transient-surface app-frosted-popover app-chat-create-popover app-chat-create-popover-enter fixed z-50 w-[min(17.75rem,calc(100vw-1.25rem))] overflow-hidden rounded-[18px] p-2.5"
        style={style}
      >
        {placement !== 'floating' ? (
          <div
