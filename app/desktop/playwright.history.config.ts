...
export default defineConfig({
  testDir: './tests/visual', testMatch: ['transcriptHistory.spec.ts', 'transcriptEntry.spec.ts', 'transcriptHistoryScrollStability.spec.ts', 'transcriptEstimateAccuracy.spec.ts'], workers: 1,
