...
export default defineConfig({
  testDir: './tests/visual', testMatch: ['transcriptHistory.spec.ts', 'transcriptEntry.spec.ts', 'transcriptHistoryScrollStability.spec.ts', 'transcriptEstimateAccuracy.spec.ts', 'transcriptSessionChange.spec.ts', 'transcriptHistoryLoading.spec.ts'], workers: 1,
