...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            chat::attachments::desktop_chat_attachment_stream_start,
            chat::attachments::desktop_chat_attachment_stream_append,
            chat::attachments::desktop_chat_attachment_stream_finish,
            chat::attachments::desktop_chat_attachment_stream_cancel,
            chat::attachments::desktop_chat_discard_attachment,
