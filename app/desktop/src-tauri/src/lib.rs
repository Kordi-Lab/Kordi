...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            canonical_sessions::chat_sync::desktop_chat_sync_deleted_message_ids,
            ...
            chat::attachments::stream::desktop_chat_attachment_stream_start,
            chat::attachments::stream::desktop_chat_attachment_stream_append,
            chat::attachments::stream::desktop_chat_attachment_stream_finish,
            chat::attachments::stream::desktop_chat_attachment_stream_cancel,
            chat::attachments::stream::desktop_chat_discard_attachment,
