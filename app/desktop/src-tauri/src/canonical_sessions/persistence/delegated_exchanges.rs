//! Delegated exchange upsert, deduplication, and row projection.

use rusqlite::{params, Connection, OptionalExtension};
use uuid::Uuid;

use super::super::{
    clean_optional, now_ms, validate_status, CanonicalDelegatedExchange,
    CreateCanonicalDelegatedExchangeRequest,
};

pub(crate) fn create_delegated_exchange_in_db(
    conn: &Connection,
...
pub(crate) fn select_delegated_exchange(
    conn: &Connection,
    id: &str,
