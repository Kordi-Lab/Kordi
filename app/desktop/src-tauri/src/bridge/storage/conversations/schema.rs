...
const BRIDGE_CONVERSATION_SCHEMA_VERSION: i64 = 3;
...
pub(in crate::bridge::storage) fn init_conversation_schema(
    ...
    ensure_bridge_message_column(conn, "attachments_json", "attachments_json TEXT")?;
    conn.execute(
