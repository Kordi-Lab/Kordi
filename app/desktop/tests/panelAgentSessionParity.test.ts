...
const virtualTranscriptSource = () => ['VirtualTranscript.tsx', 'useTranscriptVirtualizer.ts', 'TranscriptItemContent.tsx'].map(file => readFileSync(new URL(`../src/features/chat/${file}`, import.meta.url), 'utf8')).join('\n');
