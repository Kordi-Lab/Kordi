...
test('cloud group agent mention candidates include owner self-mentions for hosted Cloud Agents', () => {
  const state = {
    ...
    sessions: [],
    identities: [
      { id: 'human:me', kind: 'human', displayName: '111', source: 'bridge', sourceIdentityId: 'acct_me', humanId: 'acct_me', ownerIdentityId: null, sourceHostId: 'cloud', agentId: null, avatarKey: 'me', profileImageUrl: null, metadata: null, createdAtMs: 1, updatedAtMs: 1 },
    ],
    participants: [],
    messages: [{
      ...
      content: { mentions: [{ targetKind: 'agent', sourceHostId: 'cloud', humanId: 'acct_me', agentId: 'cloud_agent_project', label: 'Kordi Project Driver', ownerName: '111' }] },
...
test('direct Cloud contact agent mentions are not treated as Cloud group placeholders', () => {
  const state = {
    ...
    sessions: [],
    identities: [
      { id: 'human:peer', kind: 'human', displayName: 'Peer Person', source: 'bridge', sourceIdentityId: 'acct_peer', humanId: 'acct_peer', ownerIdentityId: null, sourceHostId: 'cloud', agentId: null, avatarKey: 'peer', profileImageUrl: null, metadata: null, createdAtMs: 1, updatedAtMs: 1 },
      { id: 'agent:cloud:acct_peer', kind: 'agent', displayName: "Peer Person's Kordi", source: 'bridge', sourceIdentityId: 'cloud-agent:acct_peer', humanId: 'acct_peer', ownerIdentityId: 'human:peer', sourceHostId: 'cloud', agentId: 'cloud-agent:acct_peer', avatarKey: 'peer-agent', profileImageUrl: null, metadata: null, createdAtMs: 1, updatedAtMs: 1 },
    ],
    participants: [],
    messages: [{
      ...
      content: { mentions: [{ targetKind: 'agent', sourceHostId: 'cloud', humanId: 'acct_peer', label: "Peer's Kordi" }] },
      parentMessageId: null,
      delegatedExchangeId: null,
      status: 'sent',
      sequenceNum: 1,
...
test('cloud group agent mention candidates ignore inherited fork snapshot rows', () => {
  const state = {
    ...
    messages: [{
      ...
      content: { mentions: [{ targetKind: 'agent', sourceHostId: 'cloud', humanId: 'acct_peer', label: "PeerPerson's Kordi" }] },
      parentMessageId: null,
      delegatedExchangeId: null,
      status: 'sent',
      sequenceNum: 1,
