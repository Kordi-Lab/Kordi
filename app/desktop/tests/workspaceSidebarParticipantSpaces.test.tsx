...
test('participant-space row CSS separates the timestamp and actions while adding dense dividers', () => {
  ...
  assert.match(themeTokensCss, /\.bridge-app\s*{[^}]*--app-sidebar-title-text:\s*var\(--app-text-primary\);[^}]*--app-sidebar-preview-text:\s*var\(--app-text-muted\);[^}]*--app-sidebar-time-text:\s*var\(--app-text-meta\);[^}]*--app-sidebar-accent:\s*rgb\(245 245 245\);[^}]*--app-sidebar-selected-bg:\s*rgba\(255, 255, 255, 0\.08\);/s);
  assert.match(themeTokensCss, /\.bridge-app\.theme-light\s*{[^}]*--app-sidebar-title-text:\s*var\(--app-text-primary\);[^}]*--app-sidebar-preview-text:\s*var\(--app-text-muted\);[^}]*--app-sidebar-time-text:\s*var\(--app-text-meta\);[^}]*--app-sidebar-accent:\s*rgb\(17 17 17\);[^}]*--app-sidebar-selected-bg:\s*rgb\(255 255 255\);/s);
