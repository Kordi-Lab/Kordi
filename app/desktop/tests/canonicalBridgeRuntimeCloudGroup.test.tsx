...
test('created-agent sessions keep their selected identity while hiding My Kordi mirrors', () => {
  ...
  const canonicalState = {
    ...
    messages: [
      ...
      { id: 'msg:cloud-processing', sessionId, senderIdentityId: 'agent:cloud-self:acct_me', senderRole: 'owned-agent', messageKind: 'agent-turn', contentText: 'I am US Stock', content: { cloudRequestMessageId: 'cloud-request', deliveryState: 'processing' }, parentMessageId: 'msg:cloud-request', status: 'processing', sequenceNum: 4, createdAtMs: requestAt + 1, updatedAtMs: requestAt + 1, contentHash: null, sourceTransport: 'cloud-self-agent', sourceEventId: 'cloud-processing' },
      { id: 'msg:cloud-answer', sessionId, senderIdentityId: 'agent:cloud-self:acct_me', senderRole: 'owned-agent', messageKind: 'agent-turn', contentText: 'I am US Stock Paper Trader.', content: { cloudRequestMessageId: 'cloud-request', deliveryState: 'complete' }, parentMessageId: 'msg:cloud-request', status: 'complete', sequenceNum: 5, createdAtMs: requestAt + 2, updatedAtMs: requestAt + 2, contentHash: null, sourceTransport: 'cloud-self-agent', sourceEventId: 'cloud-answer' },
    ],
    delegatedExchanges: [],
    presence: [],
    contextSnapshots: [],
