...
test('direct contacts with the same display name remain separate participant spaces', () => {
  ...
  const spaces = buildParticipantSpaces([{
    ...
    identity: { sourceHostId: 'cloud', localHumanId: 'acct_me', localHumanName: 'Me', remoteHumanId: 'acct_a', remoteHumanName: 'Shu Yang' },
  }, {
    ...baseConversation,
    ...
    identity: { sourceHostId: 'cloud', localHumanId: 'acct_me', localHumanName: 'Me', remoteHumanId: 'acct_b', remoteHumanName: 'Shu Yang' },
  }]);
