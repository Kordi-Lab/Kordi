...
test('desktop release metadata is set for V0.0.1 and iOS build 43', () => {
  ...
  assert.equal(releaseName, 'V0.0.1');
  ...
  assert.match(iosProject, /CURRENT_PROJECT_VERSION: 43/);
