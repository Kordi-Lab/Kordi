...
const releaseName = 'V0.0.1.beta13-preview.1';
const appVersion = '0.0.1-beta.13-preview.1';
...
test('desktop release metadata is set for V0.0.1.beta13-preview.1', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta13-preview.1');
