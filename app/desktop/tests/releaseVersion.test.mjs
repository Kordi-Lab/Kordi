...
const releaseName = 'V0.0.2.beta2';
const appVersion = '0.0.2-beta.2';
...
test('desktop release metadata is set for V0.0.2.beta2 and iOS 0.0.2 build 2', () => {
  ...
  assert.equal(releaseName, 'V0.0.2.beta2');
