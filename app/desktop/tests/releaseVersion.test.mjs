...
const releaseName = 'V0.0.1.beta10';
const appVersion = '0.0.1-beta.10';
...
test('desktop release metadata is set for V0.0.1.beta10', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta10');
