...
const releaseName = 'V0.0.1.beta11';
const appVersion = '0.0.1-beta.11';
...
test('desktop release metadata is set for V0.0.1.beta11', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta11');
