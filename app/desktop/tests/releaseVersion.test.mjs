...
const releaseName = 'V0.0.1.beta17';
const appVersion = '0.0.1-beta.17';
...
test('desktop release metadata is set for V0.0.1.beta17', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta17');
