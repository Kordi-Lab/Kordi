...
const releaseName = 'V0.0.2.beta3';
const appVersion = '0.0.2-beta.3';
...
test('desktop release metadata is set for V0.0.2.beta3 and iOS 0.0.2 build 3', () => {
  ...
  assert.equal(releaseName, 'V0.0.2.beta3');
