...
const releaseName = 'V0.0.2.beta1';
const appVersion = '0.0.2-beta.1';
...
test('desktop release metadata is set for V0.0.2.beta1 and iOS 0.0.2 build 1', () => {
  ...
  assert.equal(releaseName, 'V0.0.2.beta1');
  ...
  assert.match(iosProject, /MARKETING_VERSION: 0\.0\.2/);
  assert.match(iosProject, /CURRENT_PROJECT_VERSION: 1/);
