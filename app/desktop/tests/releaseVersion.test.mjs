...
const releaseName = 'V0.0.1.beta14';
const appVersion = '0.0.1-beta.14';
...
test('desktop release metadata is set for V0.0.1.beta14', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta14');
