...
const releaseName = 'V0.0.1.beta19.3';
const appVersion = '0.0.1-beta.19.3';
...
test('desktop release metadata is set for V0.0.1.beta19.3 and iOS build 42', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta19.3');
