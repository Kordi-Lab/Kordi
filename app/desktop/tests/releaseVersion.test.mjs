...
const releaseName = 'V0.0.1.beta19.2';
const appVersion = '0.0.1-beta.19.2';
...
test('desktop release metadata is set for V0.0.1.beta19.2 and iOS build 42', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta19.2');
