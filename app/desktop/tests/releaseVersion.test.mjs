...
const releaseName = 'V0.0.1.beta19.1';
const appVersion = '0.0.1-beta.19.1';
...
test('desktop release metadata is set for V0.0.1.beta19.1 and iOS build 42', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta19.1');
  ...
  assert.match(iosProject, /MARKETING_VERSION: 0\.0\.1/);
  assert.match(iosProject, /CURRENT_PROJECT_VERSION: 42/);
