...
const releaseName = 'V0.0.1.beta19';
const appVersion = '0.0.1-beta.19';
...
test('desktop release metadata is set for V0.0.1.beta19', () => {
  ...
  assert.equal(releaseName, 'V0.0.1.beta19');
