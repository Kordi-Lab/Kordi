...
enum CloudConversationCatalog {
    static func build(
        ...
        canonicalConversations: [CloudChatV2Conversation] = [],
        ...
        var canonicalConversationsBySessionId: [String: CloudChatV2Conversation] = [:]
    ...
    private static func groupConversations(
        ...
        canonicalConversations: [CloudChatV2Conversation],
        canonicalParticipantsBySessionId: [String: [CloudGroupParticipant]],
        canonicalConversationsBySessionId: [String: CloudChatV2Conversation],
