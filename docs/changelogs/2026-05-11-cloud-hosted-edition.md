...
- Cloud Edition uses `https://kordi.cloud` by default; local hosted testing uses `VITE_KORDI_CLOUD_API_BASE=http://127.0.0.1:17081` plus `KORDI_CLOUD_USE_LOCAL_TUNNEL=1`.
