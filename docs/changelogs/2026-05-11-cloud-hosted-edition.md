...
- Kordi now uses `https://coordinar.io` as the product default; development testing should set `VITE_KORDI_CLOUD_API_BASE=<PUBLIC_TEST_CLOUD_API_BASE>` or point at a self-hosted compatible server.
