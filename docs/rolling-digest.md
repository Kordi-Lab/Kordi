...
- ICS paste, file and HTTPS/webcal-link import use one shared ICAL.js adapter across desktop and iOS. Recurrence expansion, exclusions, all-day exclusive ends and included timezone definitions are supported. Unknown timezone definitions, malformed dates and limits surface import errors or warnings. Imports preserve stable identity and do not activate embedded alarms.
