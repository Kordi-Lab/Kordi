...
- [ ] **Step 4: Scope send-time mention resolution**
...
- [ ] **Step 1: Add optional owner fields to mention options**
...
- [ ] **Step 2: Move chat mention target construction after active conversation is known**
...
- [ ] **Step 3: Keep local agent only when its owner is in the group**
...
- [ ] **Step 4: Pass active conversation into chat send resolution**
