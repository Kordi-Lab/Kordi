...
| Canonical sessions | `app/desktop/src-tauri/src/canonical_sessions.rs` | Canonical session tests are partitioned by scenario, and identity/session request helpers have been extracted. Next safe slice: split group participant/admin mutations or message persistence helpers. |
