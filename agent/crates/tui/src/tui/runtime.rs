...
pub struct TuiState {
    ...
    pub input_monitor: Option<String>,
    pub input: String,
    pub cursor: usize,
    pub size: Size,
    ...
    pub(crate) slash_menu: Option<TuiSlashMenuState>,
    pub(super) select_menu: Option<TuiSelectMenuState>,
    pub(super) tree_menu: Option<super::menus::TuiTreeMenuState>,
    pub(crate) projection_dirty: bool,
    pub(super) pending_submissions: VecDeque<TuiSubmission>,
    pub(super) queued_submission_previews: VecDeque<String>,
    ...
    pub(super) auth_dialog: Option<TuiAuthDialog>,
    pub(super) approval_dialog: Option<TuiApprovalDialog>,
...
impl TuiState {
    pub fn new(config: TuiAppConfig, size: Size) -> Self {
        let mut state = Self {
            title: config.title,
            ...
            queued_submission_previews: VecDeque::new(),
    ...
    pub fn take_pending_submissions(&mut self) -> Vec<TuiSubmission> {
    ...
    pub fn refresh_projection(&mut self, preserve_anchor: bool) {
        ...
        let preserving_focus_anchor = preserve_anchor
            ...
            && matches!(self.mode, TuiMode::Transcript);
        ...
        if matches!(self.mode, TuiMode::Transcript) && self.focused_block.is_none() {
