...
pub const SUPPORT_OPENAI_PROVIDER: &str = "openai";
pub const SUPPORT_OPENAI_AUTH_CHOICE: &str = "support-service-api-key";
pub const SUPPORT_OPENAI_BASE_URL: &str = "https://api.openai.com/v1";
pub const SUPPORT_OPENAI_SNAPSHOT_ID: &str = "support-service-openai";
...
impl PendingSupportConfig {
    ...
    fn from_lookup(
        ...
        let provider_auth = SupportProviderAuth::openai_api_key(api_key, model)?;
...
mod tests {
    ...
    #[test]
    fn support_api_key_configuration_is_redacted_and_owns_the_model_route() {
        let values = HashMap::from([
            ("KORDI_SUPPORT_ENABLED", "true"),
            ("KORDI_SUPPORT_OWNER_EMAIL", "support@example.com"),
