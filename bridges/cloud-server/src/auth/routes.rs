...
fn normalized_cloud_session_title_source(value: &str) -> Option<String> {
...
fn cloud_session_title_source_precedence(value: &str) -> u8 {
    match value {
        "manual" => 4,
        "imported" | "external" => 3,
        "legacy" => 2,
...
fn incoming_cloud_session_title_wins(
...
#[cfg(test)]
mod cloud_session_title_policy_tests {
...
async fn get_cloud_session_title(
    State(state): State<Arc<ServerState>>,
    Extension(session): Extension<CloudSession>,
    axum::extract::Path(source_session_id): axum::extract::Path<String>,
) -> Response {
...
async fn update_cloud_session_title(
    State(state): State<Arc<ServerState>>,
    Extension(session): Extension<CloudSession>,
    axum::extract::Path(source_session_id): axum::extract::Path<String>,
...
async fn cloud_session_pin_summary(
    pool: &PgPool,
    account_id: &str,
    session_id: &str,
...
async fn get_cloud_session_pin(
    State(state): State<Arc<ServerState>>,
    Extension(session): Extension<CloudSession>,
    axum::extract::Path(source_session_id): axum::extract::Path<String>,
) -> Response {
...
async fn update_cloud_session_pin(
    State(state): State<Arc<ServerState>>,
    Extension(session): Extension<CloudSession>,
    axum::extract::Path(source_session_id): axum::extract::Path<String>,
