-- Both release lines used version 76. Add the digest schema without replaying
-- historical conversation cleanup or changing existing migration records.
CREATE TABLE IF NOT EXISTS cloud_account_digests (
...
CREATE TABLE IF NOT EXISTS cloud_digest_feedback (
...
CREATE TABLE IF NOT EXISTS cloud_calendar_reminder_deliveries (
